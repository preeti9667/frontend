...
const participatesAdd:React.FC<AddUserDialogProps> = ({initialValues,open, onClose, participant, onSubmit})=>{
  ...
  <DialogContent>
      ...
      >
        {({ values, setFieldValue }) => (
          <Form style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", padding: "10px" }}>
